...
func ClockFading(props IconProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/clock-fading.templ`, Line: 15, Col: 16}
			}
		...
		if props.Class != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/clock-fading.templ`, Line: 1, Col: 0}
			}
		...
		if props.Style != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/clock-fading.templ`, Line: 21, Col: 22}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "><path d=\"M12 2a10 10 0 0 1 7.38 16.75\"></path> <path d=\"M12 6v6l4 2\"></path> <path d=\"M2.5 8.875a10 10 0 0 0-.5 3\"></path> <path d=\"M2.83 16a10 10 0 0 0 2.43 3.4\"></path> <path d=\"M4.636 5.235a10 10 0 0 1 .891-.857\"></path> <path d=\"M8.644 21.42a10 10 0 0 0 7.631-.38\"></path></svg>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
