...
func UserCog(props IconProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/user-cog.templ`, Line: 15, Col: 16}
			}
		...
		if props.Class != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/user-cog.templ`, Line: 1, Col: 0}
			}
		...
		if props.Style != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/user-cog.templ`, Line: 21, Col: 22}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "><circle cx=\"18\" cy=\"15\" r=\"3\"></circle> <circle cx=\"9\" cy=\"7\" r=\"4\"></circle> <path d=\"M10 15H6a4 4 0 0 0-4 4v2\"></path> <path d=\"m21.7 16.4-.9-.3\"></path> <path d=\"m15.2 13.9-.9-.3\"></path> <path d=\"m16.6 18.7.3-.9\"></path> <path d=\"m19.1 12.2.3-.9\"></path> <path d=\"m19.6 18.7-.4-1\"></path> <path d=\"m16.8 12.3-.4-1\"></path> <path d=\"m14.3 16.6 1-.4\"></path> <path d=\"m20.7 13.8 1-.4\"></path></svg>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
