...
func CloudCog(props IconProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/cloud-cog.templ`, Line: 15, Col: 16}
			}
		...
		if props.Class != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/cloud-cog.templ`, Line: 1, Col: 0}
			}
		...
		if props.Style != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/cloud-cog.templ`, Line: 21, Col: 22}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "><circle cx=\"12\" cy=\"17\" r=\"3\"></circle> <path d=\"M4.2 15.1A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.2\"></path> <path d=\"m15.7 18.4-.9-.3\"></path> <path d=\"m9.2 15.9-.9-.3\"></path> <path d=\"m10.6 20.7.3-.9\"></path> <path d=\"m13.1 14.2.3-.9\"></path> <path d=\"m13.6 20.7-.4-1\"></path> <path d=\"m10.8 14.3-.4-1\"></path> <path d=\"m8.3 18.6 1-.4\"></path> <path d=\"m14.7 15.8 1-.4\"></path></svg>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
