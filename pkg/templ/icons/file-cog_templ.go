...
func FileCog(props IconProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/file-cog.templ`, Line: 15, Col: 16}
			}
		...
		if props.Class != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/file-cog.templ`, Line: 1, Col: 0}
			}
		...
		if props.Style != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/file-cog.templ`, Line: 21, Col: 22}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "><path d=\"M14 2v4a2 2 0 0 0 2 2h4\"></path> <path d=\"m3.2 12.9-.9-.4\"></path> <path d=\"m3.2 15.1-.9.4\"></path> <path d=\"M4.677 21.5a2 2 0 0 0 1.313.5H18a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v2.5\"></path> <path d=\"m4.9 11.2-.4-.9\"></path> <path d=\"m4.9 16.8-.4.9\"></path> <path d=\"m7.5 10.3-.4.9\"></path> <path d=\"m7.5 17.7-.4-.9\"></path> <path d=\"m9.7 12.5-.9.4\"></path> <path d=\"m9.7 15.5-.9-.4\"></path> <circle cx=\"6\" cy=\"14\" r=\"3\"></circle></svg>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
