...
func DnaOff(props IconProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/dna-off.templ`, Line: 15, Col: 16}
			}
		...
		if props.Class != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/dna-off.templ`, Line: 1, Col: 0}
			}
		...
		if props.Style != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/dna-off.templ`, Line: 21, Col: 22}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "><path d=\"M15 2c-1.35 1.5-2.092 3-2.5 4.5L14 8\"></path> <path d=\"m17 6-2.891-2.891\"></path> <path d=\"M2 15c3.333-3 6.667-3 10-3\"></path> <path d=\"m2 2 20 20\"></path> <path d=\"m20 9 .891.891\"></path> <path d=\"M22 9c-1.5 1.35-3 2.092-4.5 2.5l-1-1\"></path> <path d=\"M3.109 14.109 4 15\"></path> <path d=\"m6.5 12.5 1 1\"></path> <path d=\"m7 18 2.891 2.891\"></path> <path d=\"M9 22c1.35-1.5 2.092-3 2.5-4.5L10 16\"></path></svg>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
