...
func Columns3Cog(props IconProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/columns-3-cog.templ`, Line: 15, Col: 16}
			}
		...
		if props.Class != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/columns-3-cog.templ`, Line: 1, Col: 0}
			}
		...
		if props.Style != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/columns-3-cog.templ`, Line: 21, Col: 22}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "><path d=\"M10.5 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v5.5\"></path> <path d=\"m14.3 19.6 1-.4\"></path> <path d=\"M15 3v7.5\"></path> <path d=\"m15.2 16.9-.9-.3\"></path> <path d=\"m16.6 21.7.3-.9\"></path> <path d=\"m16.8 15.3-.4-1\"></path> <path d=\"m19.1 15.2.3-.9\"></path> <path d=\"m19.6 21.7-.4-1\"></path> <path d=\"m20.7 16.8 1-.4\"></path> <path d=\"m21.7 19.4-.9-.3\"></path> <path d=\"M9 3v18\"></path> <circle cx=\"18\" cy=\"18\" r=\"3\"></circle></svg>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
