...
func MicOff(props IconProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/mic-off.templ`, Line: 15, Col: 16}
			}
		...
		if props.Class != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/mic-off.templ`, Line: 1, Col: 0}
			}
		...
		if props.Style != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/mic-off.templ`, Line: 21, Col: 22}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "><line x1=\"2\" x2=\"22\" y1=\"2\" y2=\"22\"></line> <path d=\"M18.89 13.23A7.12 7.12 0 0 0 19 12v-2\"></path> <path d=\"M5 10v2a7 7 0 0 0 12 5\"></path> <path d=\"M15 9.34V5a3 3 0 0 0-5.68-1.33\"></path> <path d=\"M9 9v3a3 3 0 0 0 5.12 2.12\"></path> <line x1=\"12\" x2=\"12\" y1=\"19\" y2=\"22\"></line></svg>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
