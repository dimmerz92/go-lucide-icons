...
func ImageUpscale(props IconProps) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/image-upscale.templ`, Line: 15, Col: 16}
			}
		...
		if props.Class != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/image-upscale.templ`, Line: 1, Col: 0}
			}
		...
		if props.Style != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `pkg/templ/icons/image-upscale.templ`, Line: 21, Col: 22}
			}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "><path d=\"M16 3h5v5\"></path> <path d=\"M17 21h2a2 2 0 0 0 2-2\"></path> <path d=\"M21 12v3\"></path> <path d=\"m21 3-5 5\"></path> <path d=\"M3 7V5a2 2 0 0 1 2-2\"></path> <path d=\"m5 21 4.144-4.144a1.21 1.21 0 0 1 1.712 0L13 19\"></path> <path d=\"M9 3h3\"></path> <rect x=\"3\" y=\"11\" width=\"10\" height=\"10\" rx=\"1\"></rect></svg>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
